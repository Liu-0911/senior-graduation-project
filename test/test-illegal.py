...
def part3():
    ...
    print(r1)
    print('1')
    minmaxNormalData_red, minmaxNormalTime_red = MinMaxNormalization(r2, filtedData_red)
    print('2')
...
def part4():
    ...
    feature = getnonfidFeature_r_h2(list_valley, minmaxNormalData_red_h1, minmaxNormalTime_red_h1, feature)
