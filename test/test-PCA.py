...
# np.save(f'../{foldername}/illegal/feature.npy',illegal_feature)
# legal_feature = np.load("../data_illegal/feature_25_done.npy")
...
np.save(f'../{foldername}/legal/feature.npy',feature)
print(feature)
cap.release()
print("-------------------非基准特征提取完成-------------------")